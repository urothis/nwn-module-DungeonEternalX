...
{
    if(GetLevelByClass(37,oPC)>=30)  return (20+GetLevelByClass(37,oPC));
    else return 19;
}
...
void main()
{
    ...
    int nDamageDice;
    int nSaveDC = getRDDdc(OBJECT_SELF);//19;
    ...
    //cone default is 10.0
    oTarget = GetFirstObjectInShape(SHAPE_SPELLCONE, 20.0, lFinalTarget, TRUE,  OBJECT_TYPE_CREATURE | OBJECT_TYPE_DOOR  | OBJECT_TYPE_PLACEABLE);
