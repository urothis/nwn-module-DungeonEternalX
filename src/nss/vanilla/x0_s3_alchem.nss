...
void main()
{
    ...
    {
        int nDirectDamage = GetHitDice(OBJECT_SELF) + d4();
        int nSplashDamage = nDirectDamage/4;
        DoGrenade(nDirectDamage,nSplashDamage, VFX_IMP_FLAME_M, VFX_FNF_FIREBALL,DAMAGE_TYPE_FIRE,RADIUS_SIZE_HUGE, OBJECT_TYPE_CREATURE | OBJECT_TYPE_DOOR | OBJECT_TYPE_PLACEABLE);
    }
}
